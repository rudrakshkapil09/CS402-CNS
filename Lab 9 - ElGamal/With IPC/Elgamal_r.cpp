...
// Receiver side of Elgamal - using message queue
...
int main()
{
    ...
    assert(msgrcv(msq_id, &m_ds, sizeof(m_ds), 1, MSG_NOERROR) == sizeof(struct msg_ds));
    mpz_set(pubA, to_send.msg);
    gmp_printf("Got pubA - %Zd", a);
